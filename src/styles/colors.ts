...
export const colors = {
  ...
  export type ColorsIndigo = typeof colors.indigo;
  export type ColorsRed = typeof colors.red;
  export type ColorsGreen = typeof colors.green;
  export type ColorsYellow = typeof colors.yellow;
